(ns marketentry.store
  "SSoT for the SAU market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems SA" :portal "Etimad"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sa-entity? true :has-sa-entity? true
             :requires-cr? true :cr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "SAU" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Etimad"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sa-entity? true :has-sa-entity? true
             :requires-cr? true :cr-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Etimad"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "SAU" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "Etimad"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sa-entity? true :has-sa-entity? false
             :requires-cr? true :cr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "SAU" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Etimad"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-sa-entity? true :has-sa-entity? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "SAU" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Etimad"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-sa-entity? has-sa-entity?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-sa-entity?)  (assoc :engagement/requires-sa-entity? requires-sa-entity?)
    (some? has-sa-entity?)       (assoc :engagement/has-sa-entity? has-sa-entity?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-sa-entity? :engagement/has-sa-entity?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-sa-entity? (boolean (:engagement/requires-sa-entity? m))
     :has-sa-entity? (boolean (:engagement/has-sa-entity? m))
