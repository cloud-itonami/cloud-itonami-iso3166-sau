...
2. Register the client's intake: business type, target public function,
   prior filing history in Saudi Arabia if any.
3. Run the advisor in read-only mode against Etimad, the Saudi government's unified e-procurement and e-payment platform for government contracts.
...
- named referral relationship with Saudi-licensed counsel or a
...
a working referral relationship with Saudi-licensed counsel or a
registered agent for whatever licensed representation the law of
Saudi Arabia requires for actual public-procurement filings.
