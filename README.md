# cloud-itonami-iso3166-sau

Open ISO 3166 Blueprint for **SAU**: Saudi Arabia.
...
tax registration, and local-content rules in Saudi Arabia, so the operator
...
- **Not the government of Saudi Arabia.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Saudi-licensed counsel
...
(ISO 3166 `SAU`). Required capabilities:
